...
/**
 * @minions-portfolio-manager/cli — CLI for Minions Portfolio-manager
 *
...
import { customTypes } from '@minions-portfolio-manager/sdk';
...
program
    ...
    .description('Agent to manage global hierarchies, ecosystems, and projects')
    .version('0.1.0');
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Portfolio-manager'));
        console.log(chalk.dim('Agent to manage global hierarchies, ecosystems, and projects'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-portfolio-manager/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-portfolio-manager/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-portfolio-manager')}`);
